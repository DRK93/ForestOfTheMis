...
[CreateAssetMenu(fileName = "AnimalAttackData", menuName = "ScriptableObjects/AnimalAttackDataScriptableObject", order = 1)]
public class AnimalAttackScriptableObject : ScriptableObject
{
