...
namespace NGS.ExtendableSaveSystem
{
    ...
    public class GameMaster : MonoBehaviour
    {
        ...
        {
            GetComponent<SaveMaster>().Save("Assets/Saves/", "save5", ".data");
            //GetComponent<GameMenuManager>().CheckIfSaveUpdated("save5");
        }
        ...
        {
            GetComponent<SaveMaster>().Load("Assets/Saves/", "save5", ".data");
        }
    }
}
